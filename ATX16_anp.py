...
if1 = Interface('eth', '1', '210', '1', '15')
if2 = Interface('eth', '1', '211', '1', '16')

# Create VLAN 5 on the physical interfaces
vlan5_on_if1 = L2Interface('vlan5_on_if1', 'vlan', '1301')
vlan5_on_if1.attach(if1)

vlan5_on_if2 = L2Interface('vlan5_on_if2', 'vlan', '1302')
